...
# Scarpe.app :width => 400, :height => 130 do
Scarpe.app do
...
# Scarpe.app do
#   @image = test_image(url: "https://via.placeholder.com/150")
#   puts @image.inspect
# end
